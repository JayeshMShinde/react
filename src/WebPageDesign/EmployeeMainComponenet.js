        ...
        <div style={fontstyle}>
            ...
            <div style={divstyle}>
                <div className="row container">
                    <div className="col-md-3 bg-light" style={divheightStyle}>
                    <ul className="list-group">
                                ...
                                <li className="list-group-item bg-light">
                                    <Link to="profile" style={divwidthStyle} className="btn btn-danger text-light rounded-pill" >&nbsp;<b>Profile</b></Link>
                                </li>
                                <li className="list-group-item bg-light">
                                    <Link to="salary" style={divwidthStyle} className="btn btn-danger text-light rounded-pill">&nbsp;<b> Salary</b></Link>
                                </li>
                                
                                <li className="list-group-item bg-light">
                                    <Link to="experience"  style={divwidthStyle} className="btn btn-danger text-light rounded-pill">&nbsp;<b> Experience</b></Link>
                                </li>
                            </ul>
                    </div>
